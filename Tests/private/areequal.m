...
% Copy of function used in easyspin tests: 
% https://github.com/StollLab/EasySpin/blob/main/tests/private/areequal.m
...
if issparse(ok)   % Not in easyspin copy, not sure if this is necessary...
    ok = full(ok);
end
